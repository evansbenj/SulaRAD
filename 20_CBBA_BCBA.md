...
For reasons related to variation in rates of molecular evolution, I tabulated CBBA_BCBA sites with this script (Performs_CBBA_BCBA_on_populations_autosomes_haploid_outgroup.pl):
			...
			if((uc $temp[$whotoinclude[0]-1] eq "A")||(uc $temp[$whotoinclude[0]-1] eq "C")||(uc $temp[$whotoinclude[0]-1] eq "T")||(uc $temp[$whotoinclude[0]-1] eq "G")){
				...
				for ($y = 0 ; $y <= $#H3; $y++ ) {
					if(($temp[$H3[$y]+$whotoinclude[1]-2] ne './.')&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'N/N')&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'N/*')
						&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'A/*')&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'T/*')&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'G/*')
						&&($temp[$H3[$y]+$whotoinclude[1]-2] ne 'C/*')&&($temp[$H3[$y]+$whotoinclude[1]-2] ne '*/*')
