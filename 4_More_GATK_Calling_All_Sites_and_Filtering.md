...
OK, now mark indels and sites with low quality mapping.  This command should mark indels plus and minus 3 bp and sites with 1/5th or more of the reads with good map qualities to other parts of the genome (
