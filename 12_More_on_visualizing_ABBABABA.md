...
And I generated a new R script to plot the 'stats' files generated by the scripts above (genome_plot.R).  Here it is:
``` R
library (ggplot2)
...
data$colors[!is.na(data$f_dm) & abs(data$dH2H3) <= 0.003] <- "<=0.003"
